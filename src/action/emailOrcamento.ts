                  ...
                  <tr>
                      ...
                      <table style="background-color: white; margin: auto; padding: 20px; width: 50%; height: 690px; border-radius: 10px;">
                          ...
                          <td style="text-align: center;">
                              <img style="width: 200px; height: 190px; margin: 0 auto;" src="https://res.cloudinary.com/dzwboczzd/image/upload/v1727111537/WhatsApp_Image_2024-09-23_at_18.11.28_rbl0mo.jpg" alt="logo AR756" />
